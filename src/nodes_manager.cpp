...
void NodesManager::replicate_vnode_binary_name(NodesManager::replicate_vnode_args &args,
    ...
    struct pw_properties *stream_props = pw_properties_new(
        ...
        PW_KEY_APP_PROCESS_BINARY, args.onode.app_process_binary.c_str(), PW_KEY_NODE_DESCRIPTION,
        args.onode.node_description.c_str(), nullptr);
...
void NodesManager::replicate_vnode_node_desc(NodesManager::replicate_vnode_args &args,
                                             NodesManager::replicate_vnode_output &output) {
